...
public class FazTime {
	...
	private static void inicializaJogadores() {
		...
		jogadores.add(new Jogador("Andr� Guedes", 2));
		...
		jogadores.add(new Jogador("Diogo Gon�alves", 4));
		jogadores.add(new Jogador("Diogo M�ximo", 4));
		...
		jogadores.add(new Jogador("L�cio Sim�es", 3));
		jogadores.add(new Jogador("Marcelo Behera", 3));
		jogadores.add(new Jogador("Pedr�o Barros", 3));
